"""Integration tests for the /api/v1/nutrition endpoints."""
...
@pytest.fixture
def valid_headers():
    """Valid request headers with API key."""
...
class TestNutritionAuthentication:
    ...
    def test_missing_api_key_returns_401(self, client):
        ...
        response = client.get("/api/v1/nutrition/daily-goal")
...
class TestNutritionNoData:
    """Test endpoint behaviour when no Garmin data is available."""
...
class TestNutritionFullData:
    ...
    def test_full_data_returns_200(self, client, valid_headers, mock_db):
        ...
        mock_db.query_nutrition_goal = AsyncMock(return_value=self._make_full_data())
        response = client.get(
            "/api/v1/nutrition/daily-goal",
